(function (){
  ...
  function BattingCtrl(TeamSvc) {
      ...
      //
      //     this.test = document.querySelector('#batsmanScoreDetails').getElementsByClassName('player-name').value;
      //     this.test = document.querySelectorAll('ul.collection').children;
      //     this.test = document.querySelector('ul.collection').children[1].textContent = 'Hello';
      //
